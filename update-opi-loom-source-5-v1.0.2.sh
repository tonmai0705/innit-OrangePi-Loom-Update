...
[
    ...
    },
    {
        ...
        "ret": "txt",
        "paytoqs": "ignore",
        "url": "http://192.168.0.9:1880/api/product/device-opi-datasource-5",
        "tls": "",
        "persist": false,
        "proxy": "",
    ...
    },
    {
        ...
        "z": "9f979da7e8a5400d",
        "name": "function 19",
        "func": "const version = flow.get(\"vs\")\nmsg.payload = `curl -s https://raw.githubusercontent.com/tonmai0705/innit-OrangePi-Loom-Update/refs/heads/main/updaet-opi-loom-source-5-v${version}.sh | bash`\nreturn msg;",
        "outputs": 1,
        "timeout": 0,
        "noerr": 0,
        "initialize": "",
